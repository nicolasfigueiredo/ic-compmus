...
DATA_DIR_BASE = '~/documentos/compmus/birds/db-tcc-felipe/S_A_C_Base_Parte'

DATA_DIR_FULL = ['~/documentos/compmus/birds/db-tcc-felipe/S_A_C_Base_Parte-1/',
                 '~/documentos/compmus/birds/db-tcc-felipe/S_A_C_Base_Parte-2/']
